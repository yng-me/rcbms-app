...
g12_a_check <- section_g11_19 %>% 
  ...
  mutate(g12a_agrimain_grwcrps = if_else(g12a_agrimain_grwcrps == 2, 0L, g12a_agrimain_grwcrps)) %>% 
...
g12_b_check <- section_g11_19 %>% 
  ...
  mutate(g12b_agrimain_lvstckpltry = if_else(g12b_agrimain_lvstckpltry == 2, 0L, g12b_agrimain_lvstckpltry)) %>% 
...
g12_c_check <- section_g11_19 %>% 
  ...
  mutate_at(vars(matches('g12[c-e].*'), -matches('_fct$')), ~ if_else(. == 2, 0L, .)) %>% 
