...
# ============================================================================== #
source('./scripts/exports/export_merger.R')
...
# addStyle(tb, tb_sheet, table_vertical_line_inner, row_range, col_range, TRUE, TRUE)
...
#addStyle(tb, tb_sheet, table_header_align_left, start_row_header, start_col, TRUE, TRUE)
...
if(tb_without_merge_cell == FALSE) {
  ...
  setRowHeights(tb, tb_sheet, start_row + 1, row_height_header)
} else {
